...
hash_newtype!(Txid, sha256d::Hash, 32, doc="A digibyte transaction hash/transaction ID.");
hash_newtype!(Wtxid, sha256d::Hash, 32, doc="A digibyte witness transaction ID.");
hash_newtype!(BlockHash, sha256d::Hash, 32, doc="A digibyte block hash.");
hash_newtype!(SigHash, sha256d::Hash, 32, doc="Hash of the transaction according to the signature algorithm");

hash_newtype!(PubkeyHash, hash160::Hash, 20, doc="A hash of a public key.");
hash_newtype!(ScriptHash, hash160::Hash, 20, doc="A hash of digibyte Script bytecode.");
hash_newtype!(WPubkeyHash, hash160::Hash, 20, doc="SegWit version of a public key hash.");
hash_newtype!(WScriptHash, sha256::Hash, 32, doc="SegWit version of a digibyte Script bytecode hash.");
